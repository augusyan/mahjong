...
# @Author  : Yan
# @Site    :
# @File    : CNNmodel_sys_nonkings_v2.py
...
class LossHistory(keras.callbacks.Callback):
    ...
    def loss_plot(self, loss_type):
        ...
        plt.savefig('loss/loss_sysv2_e10c2d2dp5.png')
        plt.show()
...
units = 1024  # fc神经元数
num_epoch = 10  # 训练轮数
model_save_path = 'model/sys_e10c2d2dp5.h5'  # 模型保存地址
model_pic = 'model/sys_e10c2d2dp5.png'  # 绘图保存地址
...
model.add(Convolution2D(
    batch_input_shape=(None, 1, 19, 19),
    filters=64,
    kernel_size=3,
    strides=1,
