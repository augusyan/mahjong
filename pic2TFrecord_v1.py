# -*-coding:utf-8 -*-
# __author__='Yan'
# function: pics to tfrecords main funcitons; test on not MNIST
...
def read_and_decode(filename):
    ...
    # 创建一个队列来维护输入文件列表,该函数输入字符串的Tensor或者List，返回一个字符串队列
    ...
    img = tf.reshape(img, [28, 28, 1])  # reshape为128*128*3通道图片
...
if __name__ == "__main__":
    ...
    mapfile = "notMNIST_small/classmap.txt"
    train_filename = "notMNIST_small/train.tfrecords"
    createTFRecord(train_filename,mapfile)
    test_filename = "notMNIST_small/test.tfrecords"
