# -*- coding: utf-8 -*-
# @Time    : 17-12-27 上午9:25
# @Author  : Yan
# @Site    : 
# @File    : train_test_sysnthesis_model_kings_v0.py
...
# data path
trainData_tmp = np.loadtxt('data/synthesis/sys_kings_train_0.txt', delimiter=' ', dtype=np.float16)
# trainData_tmp = np.loadtxt('data/data223_train.txt', delimiter=' ', dtype=np.float16)
trainData = trainData_tmp
testData_tmp = np.loadtxt('data/synthesis/sys_kings_test_0.txt', delimiter=' ', dtype=np.float16)
...
model_save_name = '20171227_sys_king_v0_layer2_d10'
model_restore_path = "save/20171222_op_king1_v0_layer2_d10_100.ckpt"
