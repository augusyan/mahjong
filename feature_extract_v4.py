...
def calculate(handCards,handCards0,king_card,tr_king_cards,fei_king,hu):
    #print ("aaaa"+str(tr_king_cards))
    feature = []

    #1 通常手
    hand_cards = copy.deepcopy(handCards0)
    ...
    # 111 num_kingcards
    f111 = num_king(tr_king_cards)
    feature.append(f111)

    # 112-115 kingcards
    f112_115 = fun_king(tr_king_cards)
    feature = feature + f112_115
    # print feature[204:]
    ...
    # 117-129 num19
    hand_cards = copy.deepcopy(handCards)
    f117_129 = fun_19(hand_cards)
    feature = feature + f117_129

    # 130-222十三浪牌数
    hand_cards = copy.deepcopy((handCards))
    f130_222 = cal_13lan_2tiles(hand_cards)
    feature = feature + f130_222
