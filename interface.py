...
# 模型选取和训练
def model_choose(isking, list, hand_cards):
    ...
    if isking:
        ...
        # saver = tf.train.import_meta_graph("save/20171211_king3_v0_continue_100.ckpt.meta")

    else:
        input_features = 202
        model_restore_path = "save/20171211_non_king3_v0_layer2_continue_100.ckpt"
        # saver = tf.train.import_meta_graph("save/20171211_non_king3_v0_layer2_continue_100.ckpt.meta")
